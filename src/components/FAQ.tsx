const FAQSection = () => {
  return (
    <section className="bg-white dark:bg-gray-900 py-8 sm:py-12 md:py-16">
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 max-w-3xl">
        <h2 className="mb-6 sm:mb-8 text-center text-2xl sm:text-3xl md:text-4xl font-bold text-gray-800 dark:text-gray-200">
        ...
        <div className="space-y-4 sm:space-y-6">
          ...
          <details className="rounded-lg border border-gray-300 dark:border-gray-600 bg-gray-50 dark:bg-gray-800 shadow-md">
            <summary className="cursor-pointer px-4 sm:px-6 py-3 sm:py-4 font-semibold text-gray-800 dark:text-gray-200 transition hover:bg-gray-100 dark:hover:bg-gray-700">
              What is BeluStyle's return policy?
            </summary>
            <p className="bg-gray-50 dark:bg-gray-700 px-4 sm:px-6 py-3 text-sm sm:text-base text-gray-600 dark:text-gray-300">
