    ...
    <section className="w-full bg-white dark:bg-gray-900 text-gray-800 dark:text-gray-200 py-12 sm:py-16">
      <div className="container mx-auto flex flex-col-reverse items-center justify-between px-4 md:flex-row">
        ...
        <div className="space-y-4 sm:space-y-6 text-center md:w-2/3 md:text-left">
          ...
          <p className="text-sm sm:text-lg leading-relaxed text-gray-600 dark:text-gray-300">
          ...
          <div className="flex flex-col space-y-3 sm:flex-row sm:space-x-4 sm:space-y-0 justify-center md:justify-start">
            <a
              href="#"
              className="transform rounded-lg bg-gradient-to-r from-blue-500 to-blue-700 px-6 py-3 text-sm sm:text-base text-white shadow-lg transition hover:scale-105 hover:opacity-90 dark:from-blue-400 dark:to-blue-600"
            >
              Shop Now
            </a>
            <a
